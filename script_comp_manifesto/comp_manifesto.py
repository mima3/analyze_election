...
def main(argvs, argc):
    if(argc != 5):
        print ("Usage #python %s output_imagefile input_jsonfile output_jsonfile font_path" % argvs[0])
        print ('font path : ex "ms ui gothic" or "/home/fonts/ipca.ttc"')
        return -1
    input_jsonfile = argvs[1]
    output_imagefile = argvs[2]
    output_jsonfile = argvs[3]
    font_path = argvs[4]
