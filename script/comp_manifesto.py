...
def get_tokens(text):
  ...
  exclude=[u'・・・・・・・・・・・・・・・・・・・・・・・・・',u'，',u'１',u'２',u'３',u'４',u'５',u'６',u'７',u'８',u'９',u'０',u'さん',u'する',u'いる',u'やる',u'これ',u'それ',u'あれ',u'こと',u'の',u'そこ',u'なる',u'ない',u'ある']
...
def get_party_content(name,url):
  ...
  text,ret = http_pdf_to_text(url,pdftotext_path,'./tmp')
  if ret == False:
    print "(%s)のURL(%s)からPDFの取得ができませんでした (%s)" % ( name,url,text )
    return None
  return text

partys = { "自民党":"http://jimin.ncss.nifty.com/pdf/news/policy/126585_1.pdf",
