...
def print_area(url):
    ...
    areas = dom.xpath('//div[@class="snkH2Box"]/h2')
...
def main(argvs, argc):
    ...
    """
    url = 'http://www.asahi.com/senkyo/sousenkyo47/kouho/A01.html'
    for i in range(1, 48):
        url = ('http://www.asahi.com/senkyo/sousenkyo47/kouho/A%s.html' % str(i).zfill(2))
        print_area(url)
